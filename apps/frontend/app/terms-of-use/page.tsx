      ...
      <div className="mx-auto w-full max-w-3xl space-y-8">
        <header className="space-y-2">
          <div className="flex items-center justify-between gap-4">
            ...
            <Link href="/terms-of-use/en" className="text-sm text-zinc-500 underline underline-offset-4 hover:text-zinc-900">
              English
            </Link>
          </div>
        ...
        <section className="space-y-3 text-sm leading-7 text-zinc-700">
          <p>
            使用本系統即表示您同意本系統僅作為腹膜透析出口照護之輔助工具，並理解其定位為 AI 風險提示平台，結果僅為參考用，不提供任何醫療診斷或處方建議。
          </p>
          <p>
            使用者應提供真實且正確的身分與病歷比對資訊，並依畫面指示完成標準化拍攝與上傳，以維持影像品質參考結果之準確性。
          </p>
          <p>
